...
from mujoco_simulador import OpenMujoco # borrar mas tarde
import mujoco as mj
...
class Tkinter_UI(object):
    ...
    # FRAME_IZQUIERDO
       ...
       # Propiedades
        ...
        # Menu Desplegable
        self.menu_spheres = customtkinter.CTkOptionMenu(self.frame_left, values=["Esfera Roja", "Esfera Azul"], command=self.select_sphere) 
        ...
        self.open_file_dialog = customtkinter.CTkButton(self.frame_left, command=self.open_file, text= "Abrir archivo")
...
# CALLBACKS BOTONES
    ...
    def open_file(self):
        self.filepath = filedialog.askopenfilename(title="Abrir archivos .json", initialdir="./Practicas_POO/Practica_1/src/MuJoCo_config_files", filetypes=[("Archivos JSON", "*.json"),("Archivos .txt","*.txt")])
    ...
    def resize_object(self, value): 
        ...
        self.mujoco_executable.edit_object_data_callback(new_object_name=self.mujoco_executable.object_name, new_size=value)
    ...
    def select_sphere(self, value): 
        ...
        self.mujoco_executable.edit_object_data_callback(new_size=None, new_object_name=value) # Envia el nuevo nombre
